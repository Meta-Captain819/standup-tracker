// Importing env first validates required configuration at boot and crashes fast if anything is missing.
...
// Behind Render's proxy: required for correct client IPs (rate limiting) and protocol detection.
app.set("trust proxy", 1);

// CORS is locked to the Vercel frontend origin (architecture §7/§14).
...
// Terminal error handler — structured, retryable errors; never leaks internals (CLAUDE §10). Last.
