// Field-for-field mirror of backend/src/identity/identity.schemas.ts (see the drift-risk note in
// app/_lib/validation/timezones.ts — no shared workspace package exists yet).
import { z } from "zod";
